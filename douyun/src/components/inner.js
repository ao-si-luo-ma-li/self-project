...
(function() {
	...
	$('#resigter_btn').click(function() {
		...
		if (regsiter_account.length<6 || regsiter_account.length>20) {
			alert('The length of user name can only be between 6-20 characters');
			return false;
		}
		if (regsiter_password.length<6 || regsiter_password.length>20) {
			alert('The password length can only be between 6-20 characters');
			return false;
		}
	...
	$('.login_btn').click(function() {
		...
		if (login_password.length<6 || login_password.length>20) {
			alert('Password name input error');
			return false;
		}
